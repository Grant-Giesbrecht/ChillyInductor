...
parser.add_argument('--voffmv0', help='Add this vertical offset (in mV) to original file', type=float, default=0)
...
v = np.array(df['Ampl']*1e3) + args.voffmv0
...
if args.flip:
	if df4 is not None:
		ax1a.plot(t4-tshift, v4, linestyle='-', color=color4, alpha=ALPHA, label=label_4)
	if df3 is not None:
