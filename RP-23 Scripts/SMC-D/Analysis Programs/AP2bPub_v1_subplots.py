...
ax2a.plot(expected_err_x_us*1e3, np.array(expected_err_y_err)*1e3, color=GUIDE_COLOR, alpha=GUIDE_ALPHA, label="Expected error")
# ax2a.errorbar(trad_sigmas, trad_err_uncs, yerr=trad_std_uncs, linestyle='--', marker=marker_trad[0], color=COLOR_TRAD, label="Traditional", capsize=CSIZE, alpha=ERROR_ALPHA, markersize=marker_trad[1])
# ax2a.errorbar(doubler_sigmas[1:], doubler_err_uncs[1:], yerr=doubler_std_uncs[1:], linestyle='--', marker=marker_doub[0], color=COLOR_DOUB, label="Doubler", capsize=CSIZE, alpha=ERROR_ALPHA, markersize=marker_doub[1])
# ax2a.errorbar(tri_sigmas, tri_err_uncs, yerr=tri_std_uncs, linestyle='--', marker=marker_tri[0], color=COLOR_TRIPLE, label="Tripler", capsize=CSIZE, alpha=ERROR_ALPHA, markersize=marker_tri[1])
ax2a.plot(trad_sigmas, np.array(trad_err_uncs)*1e3, linestyle='--', marker=marker_trad[0], color=COLOR_TRAD, label="Traditional", alpha=ERROR_ALPHA, markersize=marker_trad[1])
ax2a.plot(doubler_sigmas[1:], np.array(doubler_err_uncs[1:])*1e3, linestyle='--', marker=marker_doub[0], color=COLOR_DOUB, label="Doubler", alpha=ERROR_ALPHA, markersize=marker_doub[1])
ax2a.plot(tri_sigmas, np.array(tri_err_uncs)*1e3, linestyle='--', marker=marker_tri[0], color=COLOR_TRIPLE, label="Tripler", alpha=ERROR_ALPHA, markersize=marker_tri[1])
ax2a.grid(True)
...
if args.save:
	fig1.savefig(os.path.join("figures", "AP2bPub_fig1.pdf"))
	fig2.savefig(os.path.join("figures", "AP2bPub_fig2.pdf"))
