...
ax1a.errorbar(trad_sigmas, trad_err_uncs, yerr=trad_std_uncs, linestyle=':', marker='o', color=COLOR_TRAD, label="Traditional, Reprocessed", capsize=CSIZE, alpha=ERROR_ALPHA)
ax1a.plot(trad_sigmas, trad_errs, linestyle='--', marker='+', color=np.array(COLOR_TRAD)*0.5, label="Traditional, Original error", markersize=MKSIZE)
ax1a.grid(True)
...
ax1b.errorbar(doubler_sigmas, doubler_err_uncs, yerr=doubler_std_uncs, linestyle=':', marker='o', color=COLOR_DOUB, label="Doubler", capsize=CSIZE, alpha=ERROR_ALPHA)
ax1b.plot(doubler_sigmas, doubler_errs, linestyle='--', marker='+', color=np.array(COLOR_DOUB)*0.5, label="Doubler, Original error", markersize=MKSIZE)
ax1b.grid(True)
...
ax1c.errorbar(tri_sigmas, tri_err_uncs, yerr=tri_std_uncs, linestyle=':', marker='o', color=COLOR_TRIPLE, label="Tripler", capsize=CSIZE, alpha=ERROR_ALPHA)
ax1c.plot(tri_sigmas, tri_errs, linestyle='--', marker='+', color=np.array(COLOR_TRIPLE)*0.5, label="Tripler, Original error", markersize=MKSIZE)
ax1c.grid(True)
