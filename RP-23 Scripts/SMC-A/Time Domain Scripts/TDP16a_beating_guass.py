...
v2 = np.sin(2*np.pi*f2*t + dphi)*np.exp(-t**2/(2*c**2))
...
ax1a.plot(t, v2-v1, linestyle=lstr, marker=mstr, color=(0.65, 0, 0))
ax1a.set_xlabel("Time")
ax1a.set_ylabel("Amplitude, v2-v1")
ax1a.grid(True)

ax1b.plot(t, v1, linestyle=lstr, marker=mstr, color=(0.65, 0, 0))
ax1b.set_xlabel("Time")
ax1b.set_ylabel("Amplitude, v1")
ax1b.grid(True)

ax1c.plot(t, v2, linestyle=lstr, marker=mstr, color=(0.65, 0, 0))
