...
lplot3d(X_, Y_, pmg_, xparam='RF Power (dBm)', yparam='RF Frequency (GHz)', zparam='Gain (dB)', fig_no=21, show_markers=True, hovertips=False, cmap=color_map)
plt.suptitle("Input Coupler Gain")

## Make a version that f_rf vs f_lo
