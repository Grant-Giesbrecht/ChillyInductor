%% Description of DS39
% Compares how ADS and measurement match up as the RF input power is
% changed.
%
% Note that my data extractor function found datapoints going normal
% towards the lower bias currents. I had to adjust my normal threshold up
% in order for the graph to plot. Be aware that this should be taken with a
% grain of salt!
%
...
load(dataset_path("ads_sweep1.mat"));
...
ylabel("Voltage (V)");
title("Comparison of 6 dBm measurement to 100K ADS Simulation");
