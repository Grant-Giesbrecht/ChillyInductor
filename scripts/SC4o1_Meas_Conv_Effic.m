...
for pwr = pwr_all
	...
	conv_effic_est2 = pwr_vna_h2./(pwr_vna_h1+pwr_vna_h2+pwr_vna_h3+pwr_vna_h4+pwr_vna_h5).*100;
	
	figure(1);
	plot(Ibias, pwr_vna_h2, 'Marker', '+', 'LineStyle', ':', 'LineWidth', 1.3, 'Color', CM(idx,:));
	hold on;
