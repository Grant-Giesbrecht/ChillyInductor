...
load(dataset_path("ads_sweep3.mat"));
Vdc_110 = Vdc;
h1_110 = h1;
h2_110 = h2;
h3_110 = h3;
...
plot(Vdc_100, h1_100+S21_h1, 'LineStyle', ':', 'LineWidth', lw, 'Marker', 'o', 'Color', [0, 0, .5], 'MarkerSize', mks);
plot(Vdc_100, h2_100+S21_h2, 'LineStyle', ':', 'LineWidth', lw, 'Marker', 'o', 'Color', [0, 0.5, 0], 'MarkerSize', mks);
plot(Vdc_100, h3_100+S21_h3, 'LineStyle', ':', 'LineWidth', lw, 'Marker', 'o', 'Color', [0.5, 0, 0], 'MarkerSize', mks);

plot(Vdc_110, h1_110+S21_h1, 'LineStyle', '-.', 'LineWidth', lw, 'Marker', '+', 'Color', [0, 0, .3], 'MarkerSize', mks);
plot(Vdc_110, h2_110+S21_h2, 'LineStyle', '-.', 'LineWidth', lw, 'Marker', '+', 'Color', [0, 0.3, 0], 'MarkerSize', mks);
plot(Vdc_110, h3_110+S21_h3, 'LineStyle', '-.', 'LineWidth', lw, 'Marker', '+', 'Color', [0.3, 0, 0], 'MarkerSize', mks);
...
ylabel("Voltage (V)");
title("Comparison of 0 dBm measurement from 100K and 110K ADS Simulation");

% Find all points, exclude -100 (zero power), and calculate minimum point
% for Y-limits.
all_points = [VNA2dBm(abs(harms.h1)), VNA2dBm(abs(harms.h2)), VNA2dBm(abs(harms.h3)), h1_100+S21_h1, h2_100+S21_h2, h3_100+S21_h3, h1_110+S21_h1, h2_110+S21_h2, h3_110+S21_h3];
idxs = (all_points <= -100);
all_points(idxs) = 0;
