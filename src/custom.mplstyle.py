...
axes.facecolor      : 6A6D80       # axes background color
...
legend.facecolor     : EAEAF2   # legend background color (when 'inherit' uses axes.facecolor)
...
figure.facecolor : EAEAF2    # figure facecolor; 0.75 is scalar gray NOTE: This does figure border color
