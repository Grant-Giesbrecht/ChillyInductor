...
parser.add_argument("--Lmin", type=float, default=0.1, help="Min total length [m]")
...
parser.add_argument("--T", type=float, default=20e-9, help="Total simulation time [s]")
...
def main():
	...
	length_list = np.linspace(args.Lmin, args.Lmax, args.num_sweep)
	...
	if args.parallel:
		...
		results = Parallel(n_jobs=args.n_jobs, prefer="processes")(delayed(process_bias_value)(vb, phys_length) for phys_length in length_list)
		...
		for phys_length in length_list:
...
# Convert list of results into 'transposed' objects
	...
	plt.plot(length_list, fdtd_exp_powers.P1_list, marker='x', label='Fundamental, Explicit', color=c_fund, linestyle='--')
	plt.plot(length_list, fdtd_exp_powers.P2_list, marker='x', label='2nd harmonic, Explicit', color=c_2h, linestyle='--')
	plt.plot(length_list, fdtd_exp_powers.P3_list, marker='x', label='3rd harmonic, Explicit', color=c_3h, linestyle='--')
	
	plt.plot(length_list, fdtd_imp_powers.P1_list, marker='+', label='Fundamental, Implicit', color=c_fund, linestyle=':')
	plt.plot(length_list, fdtd_imp_powers.P2_list, marker='+', label='2nd harmonic, Implicit', color=c_2h, linestyle=':')
	plt.plot(length_list, fdtd_imp_powers.P3_list, marker='+', label='3rd harmonic, Implicit', color=c_3h, linestyle=':')
	...
	plt.plot(length_list, le_exp_powers.P1_list, marker='x', label='Fundamental, Explicit', color=c_fundL, linestyle='--')
	plt.plot(length_list, le_exp_powers.P2_list, marker='x', label='2nd harmonic, Explicit', color=c_2hL, linestyle='--')
	plt.plot(length_list, le_exp_powers.P3_list, marker='x', label='3rd harmonic, Explicit', color=c_3hL, linestyle='--')
	
	plt.plot(length_list, le_imp_powers.P1_list, marker='+', label='Fundamental, Implicit', color=c_fundL, linestyle=':')
	plt.plot(length_list, le_imp_powers.P2_list, marker='+', label='2nd harmonic, Implicit', color=c_2hL, linestyle=':')
	plt.plot(length_list, le_imp_powers.P3_list, marker='+', label='3rd harmonic, Implicit', color=c_3hL, linestyle=':')
	...
	plt.plot(length_list, fdtd_imp_powers.P1_list, marker='x', label='Fundamental, FDTD', color=c_fund, linestyle='--')
	plt.plot(length_list, fdtd_imp_powers.P2_list, marker='x', label='2nd harmonic, FDTD', color=c_2h, linestyle='--')
	plt.plot(length_list, fdtd_imp_powers.P3_list, marker='x', label='3rd harmonic, FDTD', color=c_3h, linestyle='--')
	
	plt.plot(length_list, le_imp_powers.P1_list, marker='+', label='Fundamental, Lumped-Element', color=c_fundL, linestyle=':')
	plt.plot(length_list, le_imp_powers.P2_list, marker='+', label='2nd harmonic, Lumped-Element', color=c_2hL, linestyle=':')
	plt.plot(length_list, le_imp_powers.P3_list, marker='+', label='3rd harmonic, Lumped-Element', color=c_3hL, linestyle=':')
