...
parser.add_argument('--july', help="Use July data.", action='store_true')
...
if args.julymac:
	...
	if not data_manager.load_configuration("chirpy_conf_july.json", user_abbrevs={"$DRIVE_LETTER$":drive_letter}):
		exit()
elif args.macos:
